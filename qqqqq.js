...
function startCountdown(onDone){
  ...
  var iv=setInterval(function(){
    s--;
    numEl.textContent=s;
    arc.setAttribute('stroke-dashoffset',(total/23)*(23-s));
    if(s<=0){
      clearInterval(iv);
      numEl.textContent='\u26a1';
...
btn.onclick=function(){
  ...
  if(val!=='1'){err.textContent='\u274c Wrong key! Access denied.';inp.value='';return;}
  err.textContent='';
